...
| `project`   | pipeline stage | edits one loaded project's tasks in place (add / remove / edit) — a package with no config file is visited as `{ tasks: {} }`; core re-validates after the last plugin, and the key hashes the result                                                                                                                                                                                                                                                                       |
