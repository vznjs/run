...
export { isUserError, UserError } from './errors.js'
...
export { relPosix, staticPrefix, wholeSubtreePrefixes } from './paths.js'
...
export { CORE_VERBS, DISPATCHED_VERBS } from './verbs.js'
